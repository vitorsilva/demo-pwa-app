# Issue #TBD: Add ability to delete individual quizzes from history

**GitHub:** https://github.com/vitorsilva/saberloop/issues/TBD
**Status:** Plan Ready
**Created:** 2026-01-16
**Labels:** enhancement, ux
**Branch:** `feature/issue-TBD-delete-individual-quiz`
...
|------------|----------|-------------|
| Before | `TBD-before.png` | History view without delete button |
| After | `TBD-after.png` | History view with delete button visible |
| Modal | `TBD-modal.png` | Confirmation modal when deleting |
...
```
feature/issue-TBD-delete-individual-quiz
```
...
| 7 | `docs(issues): update plan for issue TBD` |
