...
![Results page showing 5/5](120-after.png)

The screenshot shows:
- "Anonymous" with 70 points and "Answered: 5/5 questions" ✅
- "Jogador2" with 51 points and "Answered: 5/5 questions" ✅
...
- [x] Fix implemented
- [x] Tested manually with 2+ players
- [x] Before/after screenshots captured
- [x] PR created (https://github.com/vitorsilva/saberloop/pull/132)
- [x] PR merged
