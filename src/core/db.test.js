...
describe('Sessions CRUD Operations', () => {
  ...
  it('should generate sequential IDs for multiple sessions', async () => {
    const session1 = { topicId: 'math', timestamp: Date.now(), score: 3, totalQuestions: 5 };
    const session2 = { topicId: 'science', timestamp: Date.now(), score: 4, totalQuestions: 5 };
    const session3 = { topicId: 'math', timestamp: Date.now(), score: 5, totalQuestions: 5 };
...
describe('database initialization', () => {
  it('should initialize database lazily when not initialized', async () => {
...
describe('updateQuestionExplanation', () => {
  ...
  it('should preserve other question properties when adding explanation', async () => {
    ...
    expect(session.questions[0].rightAnswerExplanation).toBe(
